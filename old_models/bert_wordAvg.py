...
PRETRAINED_MODEL_PATH = "chinese_roberta/"
BATCH_SIZE = 64
SAMPLE_FRAC = 1
NUM_LABELS = 3
EPOCHS = 3
...
class Bert_WordAvg(BertPreTrainedModel):
    ...
    def forward(self, input_ids=None, attention_mask=None, token_type_ids=None, position_ids=None,
        ...
        pooled = F.avg_pool2d(embedded, (embedded.shape[1], 1)).squeeze(1)  # [batch size, hidden_size]
        logits = self.dropout(self.classifier(pooled))
...
def main():
    ...
    model = Bert_WordAvg.from_pretrained(PRETRAINED_MODEL_PATH, num_labels=NUM_LABELS)
